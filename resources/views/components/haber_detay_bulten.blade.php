<div class="d-flex flex-column" id="bulten-abone">
  <div class="bulten-brand">
    <span>O B M O</span>
    <span><i class="fas fa-envelope"></i> Bülten</span>      
  </div>
  <p>
    Teknolojinin insanları nasıl etkilediğini gör!
  </p>
  <p>
