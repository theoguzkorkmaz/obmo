@extends('admin.layout', ['navbars2' => $navbars2, 'title' => "Navbar", 'title2' => 'index', 'title_link' => '/admin/egitim/egitim_navbars2', 'header' => "Navbar verileri"])
@section('content')
  ...
  @if(count($navbars2) == 0)
    <div class="card bg-transparent shadow-none w-50 text-center p-4">
      <div class="d-flex flex-row justify-content-between">
        ...
        <a class="btn btn-danger" href="/admin/egitim/egitim_navbars/olustur" role="button">Veri ekle <i class="far fa-plus-square ml-3"></i></a>
      </div>
    ...
    <div class="col-md-12 col-12 d-flex justify-content-end px-2">
      <a href="/admin/egitim/egitim_navbars/olustur" class="btn btn-danger btn-md mb-4 w-25">
        Yeni navbar ekle
      </a>
    </div>
            ...
            <table class="table table-bordered">
              ...
              <tr>                
                <td style="font-size: 0.85rem" colspan="2">
                  <a href="/admin/egitim/egitim_navbars/{{$item->id}}" class="btn btn-primary btn-xs w-100">
                    Detaylı gör
                  </a>
                </td>
              </tr>
              <tr>                
                <td style="font-size: 0.85rem" colspan="2">
                  <a href="/admin/egitim/egitim_navbars/{{$item->id}}/guncelle" class="btn btn-warning btn-xs w-100">
                    Güncelle
                  </a>
                </td>
              </tr>
              <tr>                
                <td style="font-size: 0.85rem" colspan="2">
                  <form method="POST" action="/admin/egitim/egitim_navbars/{{$item->id}}">
                    @csrf
                    @method('DELETE')
