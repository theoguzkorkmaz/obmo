@extends('admin.layout', ['navbars' => $navbars, 'title' => "Yorum", 'title2' => 'index', 'title_link' => '/admin/egitim/egitim_yorums', 'header' => "Yorum verileri"])
@section('content')
  ...
  @if(count($yorums) == 0)
    <div class="card bg-transparent shadow-none w-50 text-center p-4">
      <div class="d-flex flex-row justify-content-between">
        ...
        <a class="btn btn-danger" href="/admin/egitim/egitim_yorums/olustur" role="button">Veri ekle <i class="far fa-plus-square ml-3"></i></a>
      </div>
    ...
    <div class="col-md-12 col-12 d-flex justify-content-end px-2">
      <a href="/admin/egitim/egitim_yorums/olustur" class="btn btn-danger btn-md mb-4 w-25">
        Yeni yorum ekle
      </a>
    </div>
