...
@section('content')
  <div class="row">
    ...
    <div class="col-md-6 offset-md-3 mb-3 col-12 d-flex flex-row justify-content-between">
      ...
      <a class="btn btn-primary" href="/admin/egitim/egitim_sinavs" role="button"><i class="fas fa-long-arrow-alt-left mr-3"></i> Geri dön</a>
    </div>
    <div class="col-md-6 offset-md-3 col-12">
      <div class="card card-primary">
        <div class="card-header">
            <h1 style="font-size: 1.1rem;margin-bottom:0;">Sınav güncelle</h1>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
